...
\usepackage[]{svg}
\usepackage{booktabs}
\usepackage[justification=centering,tablename=Tabela]{caption}
...
\begin{figure}[h]
  \centering
  \includesvg[width=\linewidth]{figures/sdx_pack-scheme}
  \caption{Schemat tworzenia biblioteki \\
  Za \textit{SDSoC Environment User Guide: C-Callable IP Libraries},
  \url{https://china.xilinx.com/html_docs/xilinx2018_3/sdsoc_doc/c-callable-libraries-zah1504034388097.html}}\label{fig:hls4ml}
\end{figure}
...
\subsection{Implementacja pluginu sdxnet}
\todo[inline]{Tutaj też bym wstawił schemat: trzy kolumny, dwie z uproszczonym
kodem gstsdxnet i neuralnet, trzecia bloczki przedstawiające funkcje na PL.
Do tego strzałki między wywoływaniem jakiejś funkcji a jej definicją. \\
Bo gstsdxnet wywołuje różne funkcje z neuralnet, w której z kolei są
wywoływane funkcje akcelerowane i schemat ułatwi zrozumienie.}
