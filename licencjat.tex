...
częstotliwościach niż CPU. \todo{Przypis} Osiągają wysoką wydajność
...
\missingfigure{Schemat z workflow hls4ml}
...
\missingfigure{Schemat pipelinea}
...
\todo[inline]{No tu zrobić samemu schemat, nieładnie kopiować}
\begin{figure}[h]
  \centering
