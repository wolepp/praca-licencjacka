...
\begin{figure}[h]
  ...
  \includesvg[scale=0.62]{figures/nn-scheme.svg}
...
\todo[inline]{Schemat fizyczny:  wtyczka hdmi, dane leza do arma, tam kolejne wtyczki, potem delegowane sa do
sieci w logice i tak dalej }
