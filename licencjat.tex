...
\todo{Dodać przypis 1.} (FPGA architecture: survey and challenges)
...
Całość projektu została oparta o~platformę \todo{Przypis 2.}Xilinx reVISION. Przetwarzane
...
\todo{przypis 3} których przykładem jest popularna sieć \mbox{LeNet-5}.
...
z \todo{przypis 4}bazy MNIST składającej się łącznie z~70000 przykładów
